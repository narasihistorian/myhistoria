...
export default function SearchForm() {
  ...
  return (
    ...
    >
      ...
      <input
        className="bg-[#2F2F31]/50 w-full border text-base px-5 py-2 outline-none ring-[#FEDF16]/50 transition focus:ring-2 tabletMinWidth:text-2xl desktopMinWidth:text-xl"
        type="text"
        value={searchText}
        onChange={(event) => {
