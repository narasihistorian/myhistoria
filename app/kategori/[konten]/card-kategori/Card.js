...
import { montserratFont, poppinsFont, robotoFont } from '@/app/lib/FontGoogle';

// main component ----------------------------------------------------------------------

const Card = ({ image, name, description, buttondescription }) => {
  return (
    <div className="shadow-xl p-4 my-5 rounded-xl flex-1 col-span-6 tabletMinWidth:col-span-3 desktopMinWidth:col-span-2">
